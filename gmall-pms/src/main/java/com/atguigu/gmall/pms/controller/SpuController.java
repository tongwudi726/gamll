...
public class SpuController {
    ...
    public ResponseVo<PageResultVo> queryByCategoryId(
            PageParamVo pageParamVo,@PathVariable("categoryId") Long categoryId
    ){
        PageResultVo pageResultVo =this.spuService.queryByCategoryId(pageParamVo,categoryId);
